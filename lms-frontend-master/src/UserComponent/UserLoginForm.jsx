...
const UserLoginForm = () => {
  ...
  const sendOtp = (e) => {
    ...
    fetch("https://lmsbackend-production-3f74.up.railway.app/api/user/sendOtp", {
      ...
      .then((data) => {
        if (data.success) {
          toast.success(data.responseMessage || "OTP sent", {
            position: "top-center",
            autoClose: 1000,
          });
          setOtpSent(true);
          ...
          setShowResend(false);
          // after 30s allow resend
          setTimeout(() => setShowResend(true), 5000);
        } else {
          toast.error(data.responseMessage || "OTP failed", {
            position: "top-center",
            autoClose: 1000,
          });
        }
            ...
            <div className="card-body mt-3">
              <form>
                ...
                <input
                  name="_csrf"
                  type="hidden"
                  value="zDDWPqbbaqo_CYfWNxUWemplT5PdiCjOVw2WKPO84fyBD_4mqQXhC8XpDMsSPLK0BjgiT15cYqrruRvjNj2gSsfZhJ_nbZ0R"
                />
