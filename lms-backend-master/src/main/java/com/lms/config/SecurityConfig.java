...
public class SecurityConfig {
	...
	@Autowired
	public OAuthSuccessHandler handler;
	...
	@Bean
	public OtpService otpService() {return new OtpService();}
...
//commented code started
		...
		http.oauth2Login(oauth ->{
			System.out.println("Request occured for google login");
